...
public class ProjectBD {
    ...
    public static void main(String[] args) {
        ...
        success = db.createTable("CREATE TABLE IF NOT EXISTS Reunion(reunionid SERIAL NOT NULL PRIMARY KEY, fecha TIMESTAMP NOT NULL, lugar varchar(100) NOT NULL, descripcion varchar(255), organizadorid varchar(40) NOT NULL, FOREIGN KEY (organizadorid) REFERENCES Usuarios(usuid), nopagan boolean not null)");
